...
def require_password():
    ...
    with mid:
        # st.form makes the Enter key submit, not just a button click —
        # a plain st.text_input + st.button only responds to the click,
        # which reads as "broken" when someone just presses Enter.
